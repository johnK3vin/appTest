...
const HomePage = () => {
  ...
  return (
    <div className="homeContainer">
        ...
        <Link to='/test/revela tu miedo' className="Test" style={{backgroundImage: 'url("../../../public/miedo.jpg")'}}>
            <div className="divTest">Revela tu miedo mas profundo</div>
        </Link>
        <Link to='/test/decubre animal totem' className="Test" style={{backgroundImage: 'url("../../../public/imgTestAnimal/totemanimal.jpg")'}}>
